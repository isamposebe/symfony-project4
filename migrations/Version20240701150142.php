 ...
 */
final class Version20240701150142 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game ADD tour_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_232B318C15ED8D43');
        $this->addSql('ALTER TABLE game DROP tour_id');
    }
}
